  ...
  return (
    <div className="container w-x-screen mx-auto p-2">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <input className="font-montserrat text-lg text-[#6C7587] p-2 relative border-3 border-transparent outline-none text-center bg-[#EBECF0] transition-all duration-250 ease-in-out focus:border-transparent focus:border-[rgba(255,255,255,0.5)] placeholder-[#6C7587] placeholder-opacity-
